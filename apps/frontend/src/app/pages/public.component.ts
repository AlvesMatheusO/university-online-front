      ...
      <nav class="navbar">
        <div class="nav-container">
          ...
          @if (!(isAuthenticated$ | async)) {
            <button (click)="login()" class="btn-nav-login">Login</button>
          } @else {
            <div class="user-info">
      ...
      <section class="hero">
        <div class="hero-content">
          ...
          <p class="hero-subtitle">
            Plataforma completa para coordenadores, professores e estudantes
            gerenciarem suas atividades acadêmicas de forma integrada e
            eficiente.
          </p>
        ...
        <div class="container">
          ...
          <div class="features-grid">
            <div class="feature-item">
              ...
              <p>
                Organize e acompanhe matrizes curriculares, disciplinas e planos
                de curso de forma centralizada.
              </p>
            </div>
            ...
            <div class="feature-item">
              ...
              <p>
                Gerencie turmas, matrículas, frequência e desempenho acadêmico
                em tempo real.
              </p>
            </div>
            ...
            <div class="feature-item">
              ...
              <p>
                Visualize métricas, indicadores de desempenho e gere relatórios
                personalizados.
              </p>
            </div>
            ...
            <div class="feature-item">
              ...
              <p>
                Autenticação segura com controle de acesso baseado em perfis e
                permissões.
              </p>
            </div>
            ...
            <div class="feature-item">
              ...
              <p>
                Planeje e acompanhe eventos, prazos e atividades do semestre
                letivo.
              </p>
            </div>
            ...
            <div class="feature-item">
              ...
              <p>
                Facilite a comunicação entre coordenadores, professores e
                alunos.
              </p>
            </div>
          </div>
